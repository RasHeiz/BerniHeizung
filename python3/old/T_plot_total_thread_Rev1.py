...
def plotY(caption,yMin,yMax,tStep,B,H,file):
    ...
    while mulxSkala<stepxSkala:
        ...
        xSkala=(Steps*tStep)/3600/stepxSkala*mulxSkala
        #xSkala=1
        ...
        pygame.draw.line(surf, BLUE,(xPos, H-boarder-5),(xPos, H-boarder+5),2)
...
while True:
    ...
    for i in range(1,xtStep+1):
        ...
        t=tAbs-tAbsz
        if Tr>-1:
            print(Tr,Ts,Tt,Tu,Tv,Tw,Tx,Ty,Tz,T)
    ...
    if Tm>24 and Tm<26 and servoAktive is 0 and not pos is 1700:
        ...
        th1.start()
        print(th1.isAlive())
    if Tm>26 and Tm<28 and servoAktive is 0 and not pos is 2400:
        pos=2400
        th1=threading.Thread(target=Servo)
        th1.start()
        print(th1.isAlive())
